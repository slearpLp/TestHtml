...
EPIC_MONO=""
if [ -f "E:\EPIC_UE\UE_4.23\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "E:\EPIC_UE\UE_4.23\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'E:\EPIC_UE\UE_4.23\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
